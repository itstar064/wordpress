...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login ll" method="post">
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php else : ?>
				...
				<p class="priavytext"><?php esc_html_e( 'A link to set a new password will be sent to your email address.', 'woocommerce' ); ?></p>
